     ...
     return (
         <section className='space-y-6'>
             <PageTitle icon='CalendarCheck' title={`${details.courseName} ${details.classType}`} 
                       subTitle={[details.Level, 
                                  details.deleted ? 'Deleted' : 'Active',
                                  `Created At: ${details.createdAt}`]}
                       description={details.remark} editUrl={`/classes/edit?id=${id}`} />
                       ...
                       <Item variant={'outline'}>
                        ...
                        <Item variant={'outline'}>
                         ...
                         <ItemContent>
                            ...
                            <ItemDescription>{details.months} {details.months == 1 ? 'Month' : 'Months' }</ItemDescription>
                         </ItemContent>
                      </Item>
                   </div>
               </section>
